...
# ---------------------------------------------------------------------------
# Test :l1 (= :l) — with a list too large to fit on one line, multi-line
# ---------------------------------------------------------------------------
np.show(':l1', ['a very long string that will force multi-line layout',
                'another long string here to make the list wide enough',
                'third long element to ensure multiple lines are needed'])
